...
const navItems = [
  ...
  },
  {
    ...
    href: '/dashboard/skill-gap-finder',
    icon: (
      <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export default function Sidebar() {
  ...
  return (
    <aside style={{ background: '#0f172a', width: 240, minWidth: 240 }} className="flex flex-col min-h-screen">
      ...
      <div className="px-5 py-5" style={{ borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p style={{ color: '#f1f5f9', fontWeight: 700, fontSize: 15, letterSpacing: '-0.01em', lineHeight: 1 }}>Align</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5">
        <p style={{ color: '#64748b', fontSize: 10, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', padding: '0 12px', marginBottom: 6 }}>
          Tools
        </p>
        {navItems.map((item) => {
